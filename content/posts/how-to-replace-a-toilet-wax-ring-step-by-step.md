...
slug: "how-to-replace-a-toilet-wax-ring-step-by-step"
affiliate_disclosure: true
faqs:
  - q: "How long does a toilet wax ring last?"
    a: "Wax rings don't have a fixed lifespan, and a properly installed one can last decades without any issue. They typically fail because of a rocking toilet that breaks the seal over time, flange settling, or shoddy original installation rather than just age."
  - q: "Can I reuse the old wax ring if it looks fine?"
    a: "No. Once a wax ring is compressed, it's done. Even if it looks intact after removal, it won't re-seal properly when compressed again. They cost $8. Buy a new one every time."
  - q: "Why does my toilet still rock after I replaced the wax ring?"
    a: "The wax ring has nothing to do with stabilizing the toilet. Rocking after a replacement usually means the flange bolts aren't tight enough, the flange itself is damaged or sitting too low, or the floor around the toilet base is uneven. Plastic toilet shims (a couple dollars at any hardware store) can correct minor floor unevenness."
  - q: "Is the smell from a bad wax ring dangerous?"
...
That said, there are a few ways to turn a $25 repair into a $600 one. Most of them involve rushing.

## How to Know the Wax Ring Is Actually the Problem
...
**Reinstall the nuts and washers.** Hand tighten first, then snug them with a wrench, alternating sides. Do not crank them. "Snug" means the toilet doesn't move, not "as tight as I can make them." Porcelain cracks at the base more easily than you'd think. If the bolts are too long and sticking way up, use a hacksaw or bolt cutters to trim them before installing the caps.

**Reconnect the supply line and test.** Reattach the supply hose, open the shutoff valve, let the tank fill, and flush several times. Watch the base carefully. If you see any water weeping out, you didn't get a good seal and you'll need to pull it and reset it. No fun, but better to catch it now than in six months when you're replacing subfloor.
