...
Common signs your weatherstripping needs replacing include:

  * Visible cracks, tears, or gaps in the existing material
  * Cold or warm drafts coming in around closed windows
  * Higher-than-usual heating or cooling bills
  * Increased outside noise through closed windows
  * Condensation or moisture buildup around window edges
...
Here are the most common options you’ll find:
  ...
  * **Foam tape:** Inexpensive and easy to apply, great for irregular gaps. Best for windows that aren’t opened and closed frequently.
  * **V-strip (tension seal):** A durable plastic or metal strip shaped like a “V” that springs open to fill gaps. Excellent for the sides of sliding or double-hung windows.
  * **Door and window seal strips:** Rubber or silicone strips with a self-adhesive backing. Long-lasting and flexible, even in extreme temperatures.
  * **Felt strips:** An older, budget-friendly option that is less durable but easy to work with.
  * **Tubular rubber or vinyl:** A hollow tube shape that compresses when the window closes, forming a tight seal. Great for the top and bottom of window sashes.

For most home window projects, a combination of V-strip for the sides and foam or rubber seal for the top and bottom works extremely well.

## Tools and Materials You Will Need

Photo by [Gary Meulemans](https://unsplash.com/@anakin1814?utm_source=seniorstrength&utm_medium=referral) on [Unsplash](https://unsplash.com/?utm_source=seniorstrength&utm_medium=referral)

Gathering everything before you start saves time and frustration. Most of these items are inexpensive and available at any hardware or home improvement store.

**Tools:**

  * Flathead screwdriver or putty knife (for removing old weatherstripping)
  * Utility knife or scissors
  * Tape measure
  * Cleaning rags or paper towels
  * Hammer or brad nailer (if using nail-on V-strip)

**Materials:**

  * Replacement weatherstripping (foam tape, V-strip, rubber seal, or tubular vinyl)
  * Rubbing alcohol or all-purpose cleaner
  * Fine-grit sandpaper (optional, for smoothing rough surfaces)
  * Painter’s tape (optional, for marking)

**Pro Tip:** Before buying new weatherstripping, peel back a small section of the old material and bring it to the hardware store. Matching the profile and thickness of the existing weatherstripping makes the job much easier and ensures a proper fit the first time.

## Step 1: Remove the Old Weatherstripping

Start by fully opening your window so you have clear access to all the areas where weatherstripping is installed. Take a moment to examine where the old material is located before you begin pulling it away.

For adhesive-backed weatherstripping, use a flathead screwdriver or putty knife to carefully lift one edge, then peel it back slowly. Pull at a low angle to minimize tearing and keep the strip as intact as possible for reference.
...
## Step 2: Measure and Cut Your New Weatherstripping
...
**For self-adhesive foam tape or rubber seal strips:**
  ...
  * Peel back about 6 inches of the backing paper to start
  * Press the strip firmly into place, peeling and sticking as you go
  * Press firmly along the entire length with your thumb or a smooth tool
  * Trim any excess at the corners with your utility knife

**For V-strip weatherstripping:**

  * Slide or press the V-strip into the channel on the side of the window frame
  * The open end of the “V” should face outward toward the sash
...
Photo by [Carl Tronders](https://unsplash.com/@allvar?utm_source=seniorstrength&utm_medium=referral) on [Unsplash](https://unsplash.com/?utm_source=seniorstrength&utm_medium=referral)

Testing your work takes just a few minutes and tells you immediately whether the job was successful. There are two easy methods you can use right at home.

**The paper test:** Close the window on a sheet of ordinary printer paper. If you can pull the paper out easily with no resistance, the seal isn’t tight enough. If there’s firm resistance when you try to slide it out, your seal is working well.

**The flashlight test:** Have someone stand outside with a flashlight at night. Shine it around the edges of the closed window while you watch from inside in a darkened room. Any light coming through reveals a gap that needs attention.

If you find areas that aren’t sealing properly, try adding an additional layer of foam tape over the problem spot, or press the existing weatherstripping more firmly into place to ensure full adhesion.

## Frequently Asked Questions

### How long does replacement window weatherstripping last?

Most quality weatherstripping products last between 5 and 10 years with normal use. Rubber and silicone options tend to outlast foam or felt materials, especially in climates with extreme temperature changes. Checking your weatherstripping once a year during a seasonal home walkthrough helps you catch wear early.
