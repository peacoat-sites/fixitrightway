---
title: "How 2026 Tariffs Are Changing the Cost of Common DIY Projects"
date: 2026-07-11T08:30:01.103391+00:00
draft: false
description: "Discover how 2026 tariffs are raising material costs for popular DIY projects and learn smart strategies to save money on lumber, steel, and home improvement su"
image: "/img/heroes/12278570.jpg"
categories: ["trending"]
tags: ["2026", "tariffs", "changing", "cost", "common"]
...
slug: "how-2026-tariffs-are-changing-the-cost-of-common-diy-projects"
...
| Material | Tariff Situation | 2026 Cost Trend | Better Alternative |
| --- | --- | --- | --- |
| Canadian dimensional lumber | 45% combined duty | Up sharply, ~$590/MBF | Engineered wood (LVL, I-joists) |
| Imported ceramic/porcelain tile | 10% baseline tariff | Moderate increases | Domestic hardwood flooring |
| Imported steel connectors | 50% tariff | Significant increase | Specify domestic-made hardware |
| Imported cabinets (SE Asia) | 25% (possibly 50% in 2027) | Rising, window closing | Order now or go domestic brand |
| Copper plumbing | 50% tariff on copper | Up meaningfully | PEX tubing (lower tariff exposure) |
...
<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">2026 material cost increase by category (%)</div><div class="sc-row"><span class="sc-label">Framing Lumber</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">16%</span></div><div class="sc-row"><span class="sc-label">Steel/Connectors</span><span class="sc-track"><span class="sc-bar" style="width:88%"></span></span><span class="sc-val">14%</span></div><div class="sc-row"><span class="sc-label">Cabinets/Vanities</span><span class="sc-track"><span class="sc-bar" style="width:75%"></span></span><span class="sc-val">12%</span></div><div class="sc-row"><span class="sc-label">Electrical/Conduit</span><span class="sc-track"><span class="sc-bar" style="width:62%"></span></span><span class="sc-val">10%</span></div><div class="sc-row"><span class="sc-label">Engineered Wood</span><span class="sc-track"><span class="sc-bar" style="width:31%"></span></span><span class="sc-val">5%</span></div><div class="sc-src">Source: AGC Tariff Resource Center / Tax Credit Advisor Q2 2026</div></div>
...
- [AGC Tariff Resource Center for Contractors](https://www.agc.org/tariff-resources-contractors) (updated June 30, 2026)
- [2026 Construction Tariffs: Steel +25%, Cement +25% ,  Your Budget Impact (CostFlowAI)](https://costflowai.com/blog/2026-construction-tariffs-what-they-actually-mean-for-your-project-budget/) (published March 3, 2026)
- [How Tariffs Impact the Home Building Industry (NAHB)](https://www.nahb.org/advocacy/top-priorities/building-materials-trade-policy/how-tariffs-impact-home-building) (published March 23, 2026)
- [Recent Tariffs Threaten Residential Construction (Brookings Institution)](https://www.brookings.edu/articles/recent-tariffs-threaten-residential-construction/) (published October 9, 2025)
- [2026 U.S. Construction Costs ,  Q2 Update (Tax Credit Advisor)](https://www.taxcreditadvisor.com/articles/2026-us-construction-cost-outlook-q2-update/) (published April 16, 2026)
- [Tariffs and Construction Costs in 2026: What LA Homeowners Should Budget (CCS Inc.)](https://www.laconstructioncompliance.com/tariffs-construction-costs-2026-la-adu-remodeling-budget/) (published April 27, 2026)
