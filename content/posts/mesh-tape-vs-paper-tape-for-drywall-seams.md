---
title: "Mesh Tape Vs Paper Tape For Drywall Seams"
...
slug: "mesh-tape-vs-paper-tape-for-drywall-seams"
affiliate_disclosure: true
faqs:
  - q: "Can I use mesh tape with regular pre-mixed compound?"
    a: "Technically yes, but I'd steer you away from it. Pre-mixed compound shrinks too much as it dries, especially over a mesh tape that doesn't bond to the surface the way paper tape does. You'll get better results and fewer callbacks if you use a setting compound for at least the first coat over mesh tape."
  - q: "Does it matter which direction I apply paper tape on a seam?"
    a: "Not the direction, but the bedding does. The tape has to be fully embedded in wet compound with no air pockets behind it. Press from the center toward the ends. If you see bubbles after it dries, cut the bubble out with a utility knife, re-embed that section, and continue."
  - q: "Why does my tape keep bubbling or peeling after it dries?"
    a: "Usually one of two things: the compound under the tape was too dry before you embedded it, or your coat was too thick and trapped air. With paper tape, you want the base coat wet enough that the tape sinks right in. With mesh tape, bubbling typically means the compound didn't fully penetrate the weave. In either case, cut out the bad section, re-bed it, and resist the urge to rush the drying time."
  - q: "Is FibaFuse mesh tape actually better than regular fiberglass mesh tape?"
