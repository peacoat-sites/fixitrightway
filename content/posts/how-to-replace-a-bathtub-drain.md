...
image: "https://images.pexels.com/photos/8821015/pexels-photo-8821015.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
categories: ["bathroom"]
...
Common signs your drain needs replacing include:

  * Visible rust, cracks, or pitting on the drain cover or flange
  * Persistent slow draining even after cleaning out hair clogs
  * Water leaking around the base of the drain
  * A drain stopper that no longer holds water for a bath
  * Foul odors coming from a deteriorating drain seal

## Tools and Materials You Will Need

Before you start, gather everything you need in one place. Having the right tools within easy reach means fewer trips back and forth, which is especially important for your comfort and safety.
...
Drain replacement kits are inexpensive, typically costing between $10 and $40 at hardware stores. Bring a photo of your old drain to the store to make sure you get the correct replacement style.

**Pro Tip:** Before heading to the hardware store, measure your existing drain opening and note whether your tub has a toe-touch stopper, a lift-and-turn stopper, or a push-pull style. Buying the matching type makes installation much smoother and eliminates the need for extra adapters.
...
If your tub has a separate overflow plate (the oval cover near the top of the tub wall), this is also a good time to inspect it. Some drain systems connect the stopper mechanism to the overflow, meaning you may need to remove that plate first to release the stopper linkage.

**⚠️ Safety:** Never stand or kneel in the tub without a non-slip bath mat or grip pad beneath you. Wet, slippery porcelain is a fall hazard. If you have limited mobility or balance concerns, consider placing a sturdy stool beside the tub to work from, or ask a family member to assist you during this project.

## Step 2: Remove the Old Drain Stopper

Before you can remove the drain body itself, you need to take out the existing drain stopper. The removal method depends on what type of stopper your tub has.

Follow these steps based on your stopper type:

  * **Toe-touch stopper:** Open the stopper, then unscrew the small center post by turning it counterclockwise. Lift the stopper out.
  * **Lift-and-turn stopper:** Lift and turn the knob counterclockwise until it releases. Some models have a small set screw on the side that needs to be loosened first with a flathead screwdriver.
  * **Push-pull stopper:** Simply pull up on the stopper and unscrew it counterclockwise by hand.
  * **Trip-lever drain:** Remove the screws on the overflow faceplate and pull the entire stopper mechanism out through the overflow opening.

Once the stopper is out, set it aside. You may be replacing it as part of your new drain kit, or simply reusing it if it is still in good condition.
...
Once the flange is out, use a putty knife or your gloved fingers to clean away all the old putty and debris from around the drain opening. A clean surface ensures your new drain will seal properly.
...
Reinstall your drain stopper by reversing the removal steps for your particular stopper type. Make sure any set screws are tightened securely and that the stopper moves smoothly between open and closed positions.

Now, run water into the tub for a few minutes and watch carefully around the drain area. Look for any seeping water around the flange, and check beneath the tub if you have access through an adjacent closet or crawlspace. A properly installed drain will show no leaks whatsoever.

Test the stopper by filling a few inches of water and letting it sit for five minutes. If the water level holds steady, you have successfully replaced your bathtub drain.
